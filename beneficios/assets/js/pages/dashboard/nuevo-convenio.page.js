   ...
   testDate: function( campos ) {
      ...
      for (let index = 0; index < camposDate.length; index++) {
         ...
         if ( campos[ element ] ) {
            ...
            var momentDate = moment( campos[ element ] );

            if ( momentDate.isValid() ) {

               campos[ element ] = momentDate.format('YYYY/MM/DD');

            } else {

               errors.push( 'el campo "' + element + '" no es una fecha válida. el formato aceptado es YYYY/MM/DD' );
