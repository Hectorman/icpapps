module.exports = {
  ...
  fn: async function () {
    ...
    // crear una nueva tabla con la bandeja de aprobación, a cada paso asignarle un numero consecutivo.
    // en la comision dejar un campo para indicar el valor númerico del estado actual, aparte dejar otro campo para indicar estado pendiente/rechazada/aprobada.
