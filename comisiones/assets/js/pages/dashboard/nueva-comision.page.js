parasails.registerPage('nueva-comision', {
  ...
  data: {
    ...
    mensajeFinal: 'Gracias, su comisión ha sido registrada exitósamente'
  ...
  beforeMount: function() {
    ...
    if ( this.comision ) {
      ...
      this.formData = this.comision;
      this.formData.fechaInicial = moment( this.comision.fechaInicial ).format('YYYY/MM/DD');
      this.formData.fechaFinal = moment( this.comision.fechaFinal ).format('YYYY/MM/DD');
      this.mensajeFinal = 'Gracias, su comisión ha sido actualizada exitósamente';
      ...
      //if ( this.formData.ponencia == 'false' ) this.formData.ponencia = false;
  ...
  mounted: async function() {
    ...
    $('.autocomplete-ciudad').autocomplete({
      serviceUrl: 'https://madmonkeystudio.com.co/autocomplete/ciudades.php?codigo=CO',
    ...
    $('.autocomplete-pais').autocomplete({
        serviceUrl: 'https://madmonkeystudio.com.co/autocomplete/',
        onSelect: function (suggestion) {
          ...
          $('.autocomplete-ciudad').autocomplete().setOptions({
            serviceUrl: 'https://madmonkeystudio.com.co/autocomplete/ciudades.php?codigo=' + self.selectedPais,
  ...
  methods: {
    ...
    nextTab: function(e) {
      ...
      $currentStep.find('.form-group').each(function(){
          ...
          if ( thisDataErrror ) {
            ...
            if ( self.formData[ thisDataErrror ] == undefined && $this.css('display') !== 'none' ) {
    ...
    cecoChange: function(e) {

      var $radio = $(e.target),
          $group = $radio.parents('.input-group'),
