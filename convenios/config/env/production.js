...
module.exports = {
  ...
  datastores: {
    ...
    ***************************************************************************/
    default: {
      ...
      url: 'mysql://agenciat_ecoapps:htcsjqphp91@localhost:3306/agenciat_demostraciones',
    },

    usersdb: {
      adapter: require('sails-mysql'),
      url: 'mysql://agenciat_ecoapps:htcsjqphp91@localhost:3306/agenciat_usuarios_ecopetrol',
    },

    comisionesdb: {
      adapter: require('sails-mysql'),
      url: 'mysql://agenciat_ecoapps:htcsjqphp91@localhost:3306/agenciat_comisiones',
    }
  ...
  ***************************************************************************/
  custom: {
    baseUrl: 'http://www.agenciatesla.digital/',
